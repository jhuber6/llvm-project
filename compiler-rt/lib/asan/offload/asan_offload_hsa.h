...
#ifndef ASAN_OFFLOAD_HSA_H
#define ASAN_OFFLOAD_HSA_H

#include "hsa.h"
#include "sanitizer_common/sanitizer_atomic.h"
#include "sanitizer_common/sanitizer_common.h"

#define ASAN_HSA_LIBRARY "libhsa-runtime64"

namespace __asan {

#define ASAN_HSA_FUNCTIONS(X)                                                 \
...
private:
  struct Api {
#define ASAN_HSA_DECLARE(Name) decltype(&::Name) Name;
    ASAN_HSA_FUNCTIONS(ASAN_HSA_DECLARE)
