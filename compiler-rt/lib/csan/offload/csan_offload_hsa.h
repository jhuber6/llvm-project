...
#ifndef CSAN_OFFLOAD_HSA_H
#define CSAN_OFFLOAD_HSA_H

#include "hsa.h"
#include "sanitizer_common/sanitizer_atomic.h"
#include "sanitizer_common/sanitizer_common.h"

#define CSAN_HSA_LIBRARY "libhsa-runtime64"

namespace __csan {

#define CSAN_HSA_FUNCTIONS(X)                                                 \
...
private:
  struct Api {
#define CSAN_HSA_DECLARE(Name) decltype(&::Name) Name;
    CSAN_HSA_FUNCTIONS(CSAN_HSA_DECLARE)
#undef CSAN_HSA_DECLARE
  } Api;
