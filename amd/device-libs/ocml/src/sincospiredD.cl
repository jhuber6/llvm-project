...
MATH_PRIVATE(sincospired)(double x)
{
    ...
    double sx = PE5(t, 0x1.e357ef99eb0bbp-12, -0x1.e2fe76fdffd2bp-8, 0x1.50782d5f14825p-4, -0x1.32d2ccdfe9424p-1,
                      0x1.466bc67754fffp+1, -0x1.4abbce625be09p+2);
    sx = x * t * sx;
    sx = MATH_MAD(x, 0x1.921fb54442d18p+1, sx);

    double cx = PE6(t, -0x1.b167302e21c33p-14, 0x1.f9c89ca1d4f33p-10, -0x1.a6d1e7294bff9p-6, 0x1.e1f5067b90b37p-3,
