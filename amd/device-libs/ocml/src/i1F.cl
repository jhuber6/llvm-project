...
MATH_MANGLE(i1)(float x)
{
    ...
    if (a < 8.0f) {
        ...
        float2 t = sqr(a);
        float th = t.hi;
        float ph = PE5(th, 0x1.882dd2p-40f, 0x1.af97f6p-35f, 0x1.66a3eap-28f, 0x1.251b32p-22f, 0x1.84cbb6p-17f,
                         0x1.6c0d4ap-12f);
        ...
        float ph = PE2(t, -0x1.06de32p-1f, 0x1.043b22p-5f, -0x1.925276p-5f);
        float2 p = con(ph, 0.0f);
