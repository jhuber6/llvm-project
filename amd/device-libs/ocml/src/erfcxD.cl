...
MATH_MANGLE(erfcx)(double x)
{
    ...
    if (ax < 0x1.b39dc41e48bfcp+4) {
        ...
        double t = r*r;
        double p = PE6(t, 162.421875, -29.53125, 6.5625, -1.875, 0.75, -0.5, 1.0);
...
MATH_MANGLE(erfcx)(double x)
{
    ...
    if (ax < 1.0) {
        ret = PE24(x, 0x1.997339112da12p-29, -0x1.9a1485b7ae337p-27, 0x1.9548ab4c5bb56p-26,
                    -0x1.2f88b47e02dc3p-24, 0x1.282114351c39ap-22, -0x1.e533a426aadd7p-21,
                    0x1.723131b8ef11ep-19, -0x1.188f6b08d66b9p-17, 0x1.a00995a561233p-16,
                    -0x1.2aeb04681fed5p-14, 0x1.a01b9d82bcaa5p-13, -0x1.182d3bb1ac2c8p-11,
                    0x1.6c16a932f49d1p-10, -0x1.c74aef6905182p-9, 0x1.111111f403407p-7,
                    -0x1.390379458257cp-6, 0x1.5555554b34536p-5, -0x1.6023e8de7793p-4,
                    0x1.5555555597342p-3, -0x1.341f6bc020c17p-2, 0x1.fffffffffe5aep-2,
                    -0x1.812746b037cadp-1, 0x1.000000000001dp0, -0x1.20dd750429b6ap0, 0x1.0p0);
    } else if (ax < 5120.0) {
        double n = ax - 4.0;
        double d = ax + 4.0;
        double r = MATH_FAST_RCP(d);
        ...
        double p = PE22(t, 0.14981549849751462e-8, -0.69954933359042387e-8, -0.15965692247743744e-7,
                         0.92967132363414431e-7, 0.70214215034531004e-7, -0.80204958740421079e-6,
                         0.29923810132862422e-6, 0.56895739871851154e-5, -0.11226090578381133e-4,
                         -0.2438781785281914e-4, 0.00015062360829881126, -0.00019926094025574419,
                         -0.00075777387606136804, 0.0050319709983606006, -0.016197733946788412,
                         0.037167515387099868, -0.066330365824435124, 0.093732835010698844,
                         -0.10103906603561565, 0.068097054254223675, 0.015379652102604634,
                         -0.13962111684055725, 0x1.dd2c8b74febf8p-3);
        double tx = ax + ax;
        d = 1.0 + tx;
        r = MATH_FAST_RCP(d);
        ...
        ret =  MATH_DIV(one_over_sqrtpi, x) * PE2(z, 0.375, -0.5, 1.0);
    }
