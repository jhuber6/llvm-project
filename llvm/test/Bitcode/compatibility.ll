...
declare void @f.sanitize_device_address() sanitize_device_address
; CHECK: declare void @f.sanitize_device_address() #87
...
; CHECK: attributes #87 = { sanitize_device_address }
