...
; CHECK: define void @f_sanitize_device_address() #57
define void @f_sanitize_device_address() sanitize_device_address {
        ret void;
}
...
; CHECK: attributes #57 = { sanitize_device_address }
