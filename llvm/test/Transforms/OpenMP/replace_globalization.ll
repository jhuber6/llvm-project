...
; CHECK: %{{.*}} = addrspacecast i8 addrspace(3)* getelementptr inbounds ([16 x i8], [16 x i8] addrspace(3)* [[SHARED_X]], i64 0, i64 0) to i8*, !dbg !{{[0-9]+}}
...
; CHECK: %{{.*}} = addrspacecast i8 addrspace(3)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(3)* [[SHARED_Y]], i64 0, i64 0) to i8*, !dbg !{{[0-9]+}}
