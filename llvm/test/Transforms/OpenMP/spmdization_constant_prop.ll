...
; CHECK-LABEL: define weak_odr amdgpu_kernel void @__omp_offloading_20_11e3950_main_l12(
; CHECK-SAME: ptr [[DYN:%.*]], i64 noundef [[NXYZ:%.*]], i64 noundef [[NG:%.*]], ptr noundef nonnull align 8 dereferenceable(8) [[AA:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[NG1:%.*]] = alloca ptr, align 8, addrspace(5)
; CHECK-NEXT:    [[NG1_CAST:%.*]] = addrspacecast ptr addrspace(5) [[NG1]] to ptr
; CHECK-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca [2 x ptr], align 8, addrspace(5)
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_20_11e3950_main_l12_kernel_environment to ptr), ptr [[DYN]]) #[[ATTR11:[0-9]+]]
...
; CHECK-NEXT:    store ptr [[NG1_CAST]], ptr addrspace(5) [[CAPTURED_VARS_ADDRS]], align 8, !tbaa [[ANYPTR_TBAA6:![0-9]+]]
; CHECK-NEXT:    call void @__kmpc_parallel_60(ptr addrspacecast (ptr addrspace(1) @[[GLOB1:[0-9]+]] to ptr), i32 0, i32 1, i32 -1, i32 -1, ptr nonnull @__omp_outlined__, ptr nonnull null, ptr nonnull [[CAPTURED_VARS_ADDRS_ASCAST]], i64 2, i32 0)
...
; CHECK-SAME: ptr noalias captures(none) [[DOTGLOBAL_TID_:%.*]], ptr noalias captures(none) [[DOTBOUND_TID_:%.*]], ptr nonnull align 4 captures(none) [[NG:%.*]], ptr nonnull align 8 captures(none) [[AA:%.*]]) #[[ATTR2:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[ISSPMD:%.*]] = load i32, ptr addrspace(3) @IsSPMDMode, align 4
; CHECK-NEXT:    store i32 [[ISSPMD]], ptr @G, align 4
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-SAME: i16 zeroext [[TMP0:%.*]], i32 noundef [[TMP1:%.*]]) #[[ATTR3:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[ISSPMD:%.*]] = load i32, ptr addrspace(3) @IsSPMDMode, align 4
; CHECK-NEXT:    store i32 [[ISSPMD]], ptr @G, align 4
; CHECK-NEXT:    ret void
...
; CHECK-LABEL: define internal fastcc void @_ZN4ompx11synchronize14threadsAlignedEv(
; CHECK-SAME: ) unnamed_addr #[[ATTR8:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    call void @llvm.amdgcn.s.barrier() #[[ATTR12:[0-9]+]]
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-LABEL: define internal i32 @__kmpc_target_init(
; CHECK-SAME: ptr nofree noundef nonnull align 8 dereferenceable(24) [[KERNELENVIRONMENT:%.*]], ptr [[DYN:%.*]]) local_unnamed_addr #[[ATTR9:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br label %[[IF_THEN:.*]]
; CHECK:       [[IF_THEN]]:
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @llvm.amdgcn.workitem.id.x() #[[ATTR12]], !range [[RNG10:![0-9]+]]
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.amdgcn.workgroup.id.x() #[[ATTR12]]
; CHECK-NEXT:    [[TMP2:%.*]] = call align 4 dereferenceable(64) ptr addrspace(4) @llvm.amdgcn.dispatch.ptr() #[[ATTR12]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr addrspace(4) [[TMP2]], i64 12
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr addrspace(4) [[TMP3]], align 4, !invariant.load [[META11:![0-9]+]]
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr addrspace(4) [[TMP2]], i64 4
; CHECK-NEXT:    [[TMP6:%.*]] = load i16, ptr addrspace(4) [[TMP5]], align 4, !range [[RNG12:![0-9]+]], !invariant.load [[META11]]
; CHECK-NEXT:    [[CONV_I_I7_I_I_I:%.*]] = zext i16 [[TMP6]] to i32
; CHECK-NEXT:    [[MUL_I_I8_I_I_I:%.*]] = mul i32 [[TMP1]], [[CONV_I_I7_I_I_I]]
; CHECK-NEXT:    [[SUB_I_I9_I_I_I:%.*]] = sub i32 [[TMP4]], [[MUL_I_I8_I_I_I]]
; CHECK-NEXT:    [[TMP7:%.*]] = call range(i32 1, 1025) i32 @llvm.umin.i32(i32 [[SUB_I_I9_I_I_I]], i32 [[CONV_I_I7_I_I_I]]) #[[ATTR12]]
; CHECK-NEXT:    [[CMP4_I_I_I:%.*]] = icmp ult i32 [[TMP0]], [[TMP7]]
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP4_I_I_I]]) #[[ATTR13:[0-9]+]]
; CHECK-NEXT:    [[CMP_I_I8:%.*]] = icmp eq i32 [[TMP0]], 0
; CHECK-NEXT:    br i1 [[CMP_I_I8]], label %[[IF_THEN_I:.*]], label %[[_ZN4OMPX5STATE4INITEB_EXIT_CRITEDGE:.*]]
; CHECK:       [[IF_THEN_I]]:
; CHECK-NEXT:    store i32 1, ptr addrspace(3) @IsSPMDMode, align 4, !tbaa [[INT_TBAA13:![0-9]+]]
; CHECK-NEXT:    br label %[[_ZN4OMPX5STATE4INITEB_EXIT:.*]]
; CHECK:       [[_ZN4OMPX5STATE4INITEB_EXIT_CRITEDGE]]:
; CHECK-NEXT:    [[ARRAYIDX_I_I_C:%.*]] = getelementptr inbounds [1024 x i8], ptr addrspace(3) getelementptr inbounds (%"struct.(anonymous namespace)::SharedMemorySmartStackTy", ptr addrspace(3) @_ZN12_GLOBAL__N_122SharedMemorySmartStackE, i32 0, i32 1, i32 0), i32 0, i32 [[TMP0]]
; CHECK-NEXT:    br label %[[_ZN4OMPX5STATE4INITEB_EXIT]]
; CHECK:       [[_ZN4OMPX5STATE4INITEB_EXIT]]:
; CHECK-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds [1024 x ptr], ptr addrspace(3) @_ZN12_GLOBAL__N_112ThreadStatesE, i32 0, i32 [[TMP0]]
; CHECK-NEXT:    call fastcc void @_ZN4ompx11synchronize14threadsAlignedEv() #[[ATTR14:[0-9]+]]
; CHECK-NEXT:    br label %[[IF_END:.*]]
; CHECK:       [[IF_ELSE:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[IF_THEN_I30:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[_ZN4OMPX5STATE4INITEB_EXIT55_CRITEDGE:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[_ZN4OMPX5STATE4INITEB_EXIT55:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[IF_END]]:
; CHECK-NEXT:    [[TMP8:%.*]] = call i32 @llvm.amdgcn.workgroup.id.x() #[[ATTR12]]
; CHECK-NEXT:    [[TMP9:%.*]] = call align 4 dereferenceable(64) ptr addrspace(4) @llvm.amdgcn.dispatch.ptr() #[[ATTR12]]
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr addrspace(4) [[TMP9]], i64 12
; CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr addrspace(4) [[TMP10]], align 4, !invariant.load [[META11]]
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr addrspace(4) [[TMP9]], i64 4
; CHECK-NEXT:    [[TMP13:%.*]] = load i16, ptr addrspace(4) [[TMP12]], align 4, !range [[RNG12]], !invariant.load [[META11]]
; CHECK-NEXT:    [[CONV_I_I_I_I_I73:%.*]] = zext i16 [[TMP13]] to i32
; CHECK-NEXT:    [[MUL_I_I_I_I_I74:%.*]] = mul i32 [[TMP8]], [[CONV_I_I_I_I_I73]]
; CHECK-NEXT:    [[SUB_I_I_I_I_I75:%.*]] = sub i32 [[TMP11]], [[MUL_I_I_I_I_I74]]
; CHECK-NEXT:    [[TMP14:%.*]] = call range(i32 1, 1025) i32 @llvm.umin.i32(i32 [[SUB_I_I_I_I_I75]], i32 [[CONV_I_I_I_I_I73]]) #[[ATTR12]]
; CHECK-NEXT:    [[TMP15:%.*]] = call i32 @llvm.amdgcn.workitem.id.x() #[[ATTR12]]
; CHECK-NEXT:    [[CMP_I_I_I79:%.*]] = icmp ult i32 [[TMP15]], [[TMP14]]
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP_I_I_I79]]) #[[ATTR12]]
; CHECK-NEXT:    br label %[[_ZN4OMPX7MAPPING12GETBLOCKSIZEEB_EXIT_I64:.*]]
; CHECK:       [[_ZN4OMPX7MAPPING12GETBLOCKSIZEEB_EXIT_I64]]:
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    call void @llvm.assume(i1 true) #[[ATTR12]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr addrspace(3) @IsSPMDMode, align 4, !tbaa [[INT_TBAA13]]
; CHECK-NEXT:    [[TOBOOL_I59_I:%.*]] = icmp ne i32 [[TMP16]], 0
; CHECK-NEXT:    call void @llvm.assume(i1 [[TOBOOL_I59_I]]) #[[ATTR12]]
; CHECK-NEXT:    br label %[[_ZN14DEBUGENTRYRAIID2EV_EXIT250:.*]]
; CHECK:       [[_ZN4OMPX7MAPPING23ISINITIALTHREADINLEVEL0EB_EXIT:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[IF_END10:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[DO_BODY_I:.*:]]
; CHECK-NEXT:    unreachable
; CHECK:       [[_ZN14DEBUGENTRYRAIID2EV_EXIT250]]:
...
; CHECK: [[RNG10]] = !{i32 0, i32 1024}
; CHECK: [[META11]] = !{}
; CHECK: [[RNG12]] = !{i16 1, i16 1025}
; CHECK: [[INT_TBAA13]] = !{[[META14:![0-9]+]], [[META14]], i64 0}
