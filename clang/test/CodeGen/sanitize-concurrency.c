...
// CSAN-LABEL: define dso_local i32 @concurrency_feature_defined(
// CSAN-SAME: ) #[[ATTR0]] {
// CSAN-NEXT:  [[ENTRY:.*:]]
// CSAN-NEXT:    ret i32 1
//
int concurrency_feature_defined(void) { return 1; }
#endif
...
// CSAN-NEXT:    call void @__csan_read4(ptr [[TMP1]])
// CSAN-NEXT:    [[TMP2:%.*]] = load i32, ptr [[TMP1]], align 4
// CSAN-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CSAN-NEXT:    call void @__csan_read4(ptr [[TMP3]])
