...
elseif(detected_gpu_architectures)
  ...
  # FIXME: The handling for missing tests is broken, just default to whatever.
    set(gpu_test_architecture "gfx90a")
    message(STATUS "Using defaulted GPU architecture for testing: "
                  "'${gpu_test_architecture}'")
endif()
